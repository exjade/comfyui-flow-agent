...
function applyVideoMode(node) {
    ...
    if (node.flowVideoModeHelp) {
        const labels = {
            ...
            "edit source video": "Requires 1 source video · optional visual references · count fixed to 1",
            "video to video": "Requires 1 source video · optional visual references · count fixed to 1",
        };
